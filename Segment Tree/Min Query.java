...
Jacob has to find the minimum value of all the elements from l to r.
...
Explanation
The minimum element from index 1 to index 2 is 1, similarly for other queries (1 based indexing). */
...
import java.io.*;
  ...
  class SegmentTree //Minimum Query Segment Tree
  {
