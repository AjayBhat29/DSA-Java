...
class Pair implements Comparable<Pair>
{
    ...
    public Pair(int pass,int total)
    {
        this.pass=pass;
        this.total=total;
        double a=(double)(pass+1)/(total+1);
        double b=(double)pass/total;
        this.gain=a-b;
    }
    ...
    public void update()
    {
        this.pass++;
        this.total++;
        double a=(double)(this.pass+1)/(this.total+1);
        double b=(double)this.pass/this.total;
        this.gain=a-b;
    }
}
